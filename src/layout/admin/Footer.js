          ...
          <div className="row">
            <div className="footer-right col-12 col-md-4 col-lg-4">
              <h1 className="logo2 fw-bold">
                <img className="img ms-1" src={image} alt="Logo KamarSinau" />
                {"   "}
                <span className="kamar">Kamar</span>
                <span className="sinau">Sinau</span>
              </h1>
              <p className="ms-3 text-white">
                Untuk Informasi yang lebih Details, Anda dapat mengunjungi dan
                Mengikuti akun kami Di:
              </p>
              <div className="sosial-media-list d-flex ms-3">
                <div className="sosial-media me-2">
                  <FaGithub />
                </div>
                <div className="sosial-media me-2">
                  <FaLinkedin />
