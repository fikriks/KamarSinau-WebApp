            ...
            <div className="container-fluid">
                <div className="row justify-content-center align-items-center">
                    <div className="col-12 header-introduction">
                        ...
                        <div className="font">
                            <p>KamarSinau Apps</p>
                            <p>KamarSinau adalah sebuah Website yang menyediakan berbagai materi yang dapat diakses tanpa batas usia, baik itu untuk siswa SD,SMP dan SMA. Dengan Adanya Website ini diharapkan dapat memudahkan menguasai materi bagi yang sedang belajar.</p>
